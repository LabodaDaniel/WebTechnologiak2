  ...
  methods: {
    ...
    chartCalc() {
      ...
      if (enemyCards.length > 45539) {
        ...
        this.percentOfChance = Math.round((sum/myChance.length)*100)/100;
        ...
        let downDev = avg - this.calculateDeviation(eChance);
        let upDev = avg + this.calculateDeviation(eChance);
        let downDevArr = [];
        let upDevArr = [];
        let medArr = [];
        let avgArr = [];
        ...
        this.percentOfChance = Math.round([myColumn]*100)/100;
        this.showChance = true;
